...
A primary goal of [GDG Tyumen](http://tmncode.cio72.ru/) is to be inclusive to the largest number of contributors, with the most varied and diverse backgrounds possible. As such, we are committed to providing a friendly, safe and welcoming environment for all, regardless of gender, sexual orientation, ability, ethnicity, socioeconomic status, and religion (or lack thereof). 
GDG Tyumen prides itself on being an open, respectful, and inclusive community. That means the [jerky behavior](https://meta.wikimedia.org/wiki/Don%27t_be_a_jerk) isn’t allowed at GDG meetings.
...
- Anatoly Zolotov, +7 922 488 00 11, [hello@gdgtmn.ru](mailto:hello@gdgtmn.ru)
- Artem Glazkov, +7 919 959 79 27, [hello@gdgtmn.ru](mailto:hello@gdgtmn.ru)
